  ...
  return (
    <>
      ...
      <UpgradePlanModal
        ...
        text={`Your current plan does not include access to ${popUp.upgradePlan.data?.featureName}. To unlock this feature, please upgrade to Hanzo KMS ${popUp.upgradePlan.data?.isEnterpriseFeature ? "Enterprise" : "Pro"} plan.`}
      />
    </>
  );
};
