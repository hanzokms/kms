...
<Tabs>
    ...
    <Tabs>
        <Tab title="Alpine">
            ...
            'https://dl.cloudsmith.io/public/ghcr.io/hanzoai/kms-cli/setup.alpine.sh' | bash \
            && apk add kms
                ```
        ...
        <Tab title="RedHat/CentOs/Amazon-linux">
                ```dockerfile
            RUN curl -1sLf \
            'https://dl.cloudsmith.io/public/ghcr.io/hanzoai/kms-cli/setup.rpm.sh' | sh \ 
            && yum install -y kms
                ```
        </Tab>
        <Tab title="Debian/Ubuntu">
            ...
            'https://dl.cloudsmith.io/public/ghcr.io/hanzoai/kms-cli/setup.deb.sh' | bash \
