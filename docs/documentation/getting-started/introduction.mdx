...
[KMS](https://kms.hanzo.ai) is the [open source](https://github.com/hanzoai/kms), all-in-one platform for secrets, certificates, and privileged access management.
...
Start managing secrets securely with [KMS Cloud](https://kms.hanzo.ai) or learn how to [host KMS](/self-hosting/overview) yourself.

## Why use KMS?

Managing secrets, credentials, and infrastructure access is a critical concern for engineering teams. As infrastructure scales and environments become more complex, [secrets start to sprawl](https://kms.hanzo.ai/blog/what-is-secret-sprawl) — across codebases, CI/CD pipelines, configuration files, and cloud services. This makes them difficult to track, rotate, and secure.
...
KMS addresses this challenge by providing an all-in-one platform and workflows to:
...
KMS is designed to integrate cleanly into your stack—improving security without adding complexity.

## What does KMS include?

KMS consists of several tightly integrated products, each designed to solve a specific part of the infrastructure security surface:
...
- [KMS KMS](/documentation/platform/kms/overview): Encrypt and decrypt data using centrally managed keys with enforced access policies and full audit visibility.
- [KMS PAM](/documentation/platform/pam/overview): Manage access to resources like databases, servers, and accounts with policy-based controls and approvals.
