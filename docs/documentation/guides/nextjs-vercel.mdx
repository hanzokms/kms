...
1. Create a new project in [KMS](https://kms.hanzo.ai/).
...
Use our [Vercel Secret Syncs](../../integrations/secret-syncs/vercel) guide to sync secrets from KMS to Vercel as production environment variables.
