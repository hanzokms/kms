...
<Steps>
    ...
    <Step title="Set Up KMS in an Azure Function">
        ...
        You can add KMS in an Azure Function quite easily using the [KMS SDK for .NET](https://kms.hanzo.ai/docs/sdks/languages/csharp) (or other languages). This enables the function to communicate with KMS to obtain secrets, among other things.
