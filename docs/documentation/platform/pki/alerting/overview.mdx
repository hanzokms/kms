...
In order to ensure that your certificates are always up-to-date and not expired, you can set up alerting in KMS for expiring CA and leaf certificates based on customizable filters.
