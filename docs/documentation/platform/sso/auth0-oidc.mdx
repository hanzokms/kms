...
<Steps>
   <Step title="Setup application in Auth0">
      ...
      1.2. In the Application URIs section, set the **Application Login URI** and **Allowed Web Origins** fields to `https://kms.hanzo.ai` and the **Allowed Callback URL** field to `https://kms.hanzo.ai/api/v1/sso/oidc/callback`.
