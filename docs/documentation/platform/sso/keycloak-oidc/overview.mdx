...
<Info>
    ...
    you should contact sales@kms.hanzo.ai to purchase a self-hosted license to
    use it.
</Info>
...
<Steps>
    <Step title="Create an OIDC client application in Keycloak">
        ...
        - Root URL: `https://kms.hanzo.ai`.
        - Home URL: `https://kms.hanzo.ai`.
        - Valid Redirect URIs: `https://kms.hanzo.ai/api/v1/sso/oidc/callback`.
        - Web origins: `https://kms.hanzo.ai`.

        ![OIDC keycloak create client login settings](/images/sso/keycloak-oidc/create-client-login-settings.png)
        <Info>
            If you’re self-hosting KMS, then you will want to replace https://kms.hanzo.ai (base URL) with your own domain.
        </Info>
...
<Tip>
    If you are only using one organization on your KMS instance, you can configure a default organization in the [Server Admin Console](/documentation/platform/admin-panel/server-admin#default-organization) to expedite OIDC login.
</Tip>
