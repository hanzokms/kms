...
<Steps>
  ...
  <Step title="Add your OAuth2 application credentials to KMS">
    ...
    - `SITE_URL`: The URL of your self-hosted instance of KMS - should be an absolute URL including the protocol (e.g. https://kms.hanzo.ai)
...
<AccordionGroup>
  <Accordion title="Why is Google SSO not working?">
    ...
    For example, if the former is `https://kms.hanzo.ai/api/v1/sso/google` then the latter should be `https://kms.hanzo.ai`.
  </Accordion>
</AccordionGroup>