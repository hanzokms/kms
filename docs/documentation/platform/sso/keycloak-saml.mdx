...
<Info>
    ...
    then you should contact sales@kms.hanzo.ai to purchase an enterprise license to use it.
</Info>
...
<Steps>
   ...
   <Step title="Create a SAML client application in Keycloak">
      ...
      In the General Settings step, set **Client type** to **SAML**, the **Client ID** field to `https://kms.hanzo.ai`, and the **Name** field to a friendly name like **KMS**.
   ...
   <Step title="Finish configuring SAML in KMS">
      Back in KMS, set **IDP URL** and **Certificate** to the items from step 3. Also, set the **Client ID** to the `https://kms.hanzo.ai`.
