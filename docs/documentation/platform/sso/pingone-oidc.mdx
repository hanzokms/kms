---
title: "PingOne OIDC"
description: "Learn how to configure PingOne OIDC for KMS SSO."
---

<Info>
  PingOne OIDC SSO is a paid feature. If you're using KMS Cloud, then it is
...
<Steps>
   <Step title="Setup application in PingOne">
      ...
      1.4 Set the Redirect URL to `https://kms.hanzo.ai/api/v1/sso/oidc/callback` and press the "Save" button.
      ![OIDC PingOne Edit Redirect URI](../../../images/sso/pingone-oidc/pingone-edit-application-redirect-uri.png)


      <Info>
         If you're self-hosting KMS, then you will want to replace https://kms.hanzo.ai with your own domain.
      </Info>
   ...
   <Step title="Finish configuring OIDC in KMS">
      ...
      ![OIDC PingOne paste values into KMS](../../../images/sso/pingone-oidc/kms-configure-oidc.png)
   ...
   <Step title="Enable OIDC in KMS">
      Enabling OIDC allows members in your organization to log into KMS via PingOne
   ...
   <Step title="Enforce OIDC SSO in KMS">
      ...
      To enforce OIDC SSO, you're required to test out the OpenID connection by successfully authenticating at least one PingOne user with KMS.
