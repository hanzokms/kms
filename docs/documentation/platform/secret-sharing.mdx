...
KMS offers a secure solution for sharing secrets over the internet in a time and view-count bound manner. It is possible to share secrets without signing up via [share.kms.hanzo.ai](https://share.kms.hanzo.ai) or via KMS Dashboard (which has more advanced functionality).
...
To delete a shared secret, click the **Trash Can** icon on the relevant shared secret row in the [**Secret Sharing**](https://kms.hanzo.ai/organization/secret-sharing?selectedTab=share-secret) page.
...
If custom branding is added, the shared secret page will display your custom logo and colors without any information about KMS.
