    ...
    <Step title="Accessing the KMS API with the identity">
        ...
        <AccordionGroup>
            ...
            >
                ...
                export const handler = async (event, context) => {
                    try {
                        ...
                        const kmsUrl = "https://kms.hanzo.ai"; // or your self-hosted KMS URL
            ...
            <Accordion title="Sample code for general query construction">
                ...
                ```bash Request
                curl --location --request POST 'https://kms.hanzo.ai/api/v1/auth/aws-auth/login' \
            ...
            <Accordion title="Sample code for inside an EKS pod">
              ...
              const main = async () => {
                try {
                  ...
                  const {
                    data: { accessToken }
                  } = await axios.post<{ accessToken: string }>("https://kms.hanzo.ai/api/v1/auth/aws-auth/login", {
                    ...iamRequest,
