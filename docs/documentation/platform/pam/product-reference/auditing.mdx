...
description: "Learn how KMS audits all actions across your PAM project."
---

## What's Audited

KMS logs a wide range of actions to provide a complete audit trail for your PAM project. These actions include:

- Session Start and End
- Fetching session credentials
- Creating, updating, or deleting resources, accounts, and sessions
