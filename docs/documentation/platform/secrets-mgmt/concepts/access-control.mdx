...
description: "Learn how access to secrets is controlled in KMS."
---

## Secret Hierarchy

Every secret in KMS is scoped to an environment and a path.
...
Beyond basic role assignments, KMS includes additional access control mechanisms for more advanced use cases:
