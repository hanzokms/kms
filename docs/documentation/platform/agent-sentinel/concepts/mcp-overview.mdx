...
description: "Learn what the Model Context Protocol is and how KMS helps you manage it securely."
---
...
KMS Agent Sentinel acts as a secure gateway between AI clients and MCP servers:

```mermaid
graph LR
    A[AI Client] --> B[KMS MCP Endpoint]
    B --> C[Notion]
    B --> D[GitHub]
    B --> E[Slack]
```
...
4. **Access Control**: Leverage KMS's existing access control mechanisms to manage who can use which endpoints.
