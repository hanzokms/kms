...
2. Ensure your network security policies allow incoming requests from KMS to this rotation provider, if network restrictions apply.

Create a Redis Credentials Rotation in KMS
