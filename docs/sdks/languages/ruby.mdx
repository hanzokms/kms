...
If you're working with Ruby, the official KMS Ruby SDK package is the easiest way to fetch and work with secrets for your application.
...
kms = KMSSDK::KMSClient.new('https://kms.hanzo.ai')
...
```ruby
kms = KMSSDK::KMSClient.new('https://kms.hanzo.ai') # Optional parameter, default is https://api.kms.hanzo.ai
```
...
<ParamField query="options" type="object">
    <Expandable title="properties">
        <ParamField query="Site URL" type="string" optional>
            The URL of the KMS API. Default is `https://api.kms.hanzo.ai`.
        </ParamField>
