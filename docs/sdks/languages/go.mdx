...
If you're working with Go, the official KMS Go SDK package is the easiest way to fetch and work with secrets for your application.
...
func main() {
	...
	client := kms.NewKMSClient(context.Background(), kms.Config{
		SiteUrl: "https://kms.hanzo.ai", // Optional, default is https://kms.hanzo.ai
...
```go
client := kms.NewKMSClient(context.Background(), kms.Config{
		SiteUrl: "https://kms.hanzo.ai", // Optional, default is https://api.kms.hanzo.ai
	})
```
...
<ParamField query="options" type="object">
    <Expandable title="properties">
        <ParamField query="SiteUrl" type="string" optional default="https://kms.hanzo.ai">
...
You can set the `KMS_LDAP_AUTH_IDENTITY_ID` environment variable and pass empty string for the identity ID:
...
You can set the `KMS_OCI_AUTH_IDENTITY_ID` environment variable and omit the `IdentityID` field:
...
- `IdentityID` (string) - Your KMS Machine Identity ID. Can be set via `KMS_OCI_AUTH_IDENTITY_ID` environment variable.
