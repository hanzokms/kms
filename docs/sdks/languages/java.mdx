...
If you're working with Java, the official KMS Java SDK package is the easiest way to fetch and work with secrets for your application. 
...
### Gradle
```gradle
  implementation group: 'com.kms', name: 'sdk', version: '{version}'
```


### Others
For other build tools, please check our [package snippets](https://central.sonatype.com/artifact/com.kms/sdk), and select the build tool you're using for your project.
...
import com.kms.sdk.KMSSdk;
import com.kms.sdk.SdkConfig;
  ...
  public static void main(String[] args) {
    var sdk = new KMSSdk(
      new SdkConfig.Builder()
        // Optional, will default to https://kms.hanzo.ai
        .withSiteUrl("https://your-kms-instance.com")
        .build()
    );
