...
If a release requires specific attention, a note will be attached to the corresponding [release](https://github.com/hanzoai/kms/releases) version.
...
2. **Plan Your Upgrade Path:**
   - Use our [Upgrade Path Tool](https://kms.hanzo.ai/upgrade-path) to analyze your upgrade path between your current version and target version.
   ...
   - Visit the [KMS releases page](https://github.com/hanzoai/kms/releases) for a complete list of available versions.
...
After upgrading your KMS instance, you may encounter UI-related issues such as:
...
While we recommend staying up-to-date with the latest version, there may be scenarios where you need to downgrade your KMS instance.
...
2. **Stop KMS Services:**
   - Gracefully shut down all KMS instances to prevent data corruption
...
4. **Deploy Previous Version:**
   - Deploy the previous KMS version
