...
<Steps>
  ...
  <Tabs>
    ...
    <Warning>
      As of October 10, 2025, all future releases for Debian/Ubuntu will be distributed via the official KMS repository at https://artifacts-kms-core.kms.hanzo.ai.
      ...
      > **Note**: For production use, we recommend locking to a specific version to ensure consistency. [View available versions](https://github.com/hanzoai/kms/releases). All versions from `kms-core-0.150.0~nightly~20251005` and above are supported.

  </Tab>
    <Tab title="RedHat/CentOS/Amazon Linux">

    <Warning>
      As of October 10, 2025, all future releases for Red Hat/CentOS/Amazon Linux will be distributed via the official KMS repository at https://artifacts-kms-core.kms.hanzo.ai.
