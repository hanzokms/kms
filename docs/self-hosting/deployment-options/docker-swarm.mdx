...
The [Docker stack file](https://github.com/hanzoai/kms/tree/main/docker-swarm) used in this guide defines the services and their configurations for deploying KMS in a highly available manner. The main components of this stack are as follows.
...
<Steps>
  ...
  - [Docker stack file](https://github.com/hanzoai/kms/blob/main/docker-swarm/stack.yaml) (rename to kms-stack.yaml)
  - [HA configuration file](https://github.com/hanzoai/kms/blob/main/docker-swarm/haproxy.cfg) (rename to haproxy.cfg)
  - [Example .env file](https://github.com/hanzoai/kms/blob/main/docker-swarm/.env-example) (rename to .env)
  </Step>
  ...
  <Step title="Check service status">
    ...
    jaewzqy8md56   kms_kms         replicated   5/5        ghcr.io/hanzoai/kms:v0.60.1-postgres   
