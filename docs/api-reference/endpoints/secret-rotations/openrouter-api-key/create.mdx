---
title: "Create"
openapi: "POST /api/v2/secret-rotations/open-router-api-key"
---
...
Creates an OpenRouter API Key secret rotation. KMS will create and rotate API keys via your [OpenRouter connection](/integrations/app-connections/openrouter) and write them to the specified secret path.
...
```bash
curl --request POST \
  --url https://us.kms.hanzo.ai/api/v2/secret-rotations/open-router-api-key \
