...
KMS enforces several different types of rate limits:
...
**Self-hosted** instances have no limits, these limits apply only to **KMS Cloud**.
...
<Note>
    Custom rate limits are available for Enterprise customers. If you need higher rate limits, please contact sales@kms.hanzo.ai.
</Note>
