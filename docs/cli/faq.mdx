...
If none of the available stores work for you, you can try using the `file` store type by running `hanzo-kms vault set file`, which should work in most cases. 
...
<Accordion title="Where can I find my Project ID?">
  ...
  ```
    https://kms.hanzo.ai/project/<your_project_id>/settings
  ```
</Accordion>
