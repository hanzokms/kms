...
- Ensure your network security policies allow incoming requests from KMS to this secret sync provider, if network restrictions apply.
...
<Tabs>
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.hanzo.ai/api/v1/secret-syncs/oci-vault \
