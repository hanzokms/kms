...
<Tabs>
    <Tab title="KMS UI">
        <Steps>
            ...
            <Step title="Configure sync options">
                ...
                - **Auto Redeploy On Secret Change**: If enabled, KMS will restart all app machines after syncing or removing secrets so they pick up the new values immediately.
                <Note>
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.hanzo.ai/api/v1/secret-syncs/flyio \
