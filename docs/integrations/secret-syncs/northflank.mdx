...
description: "Learn how to configure a Northflank Sync for KMS."
---
...
<Tabs>
        ...
        <Steps>
            ...
            <Step title="Configure sync options">
                ...
                - **Initial Sync Behavior**: Determines how KMS should resolve the initial sync.
                    ...
                    - **Import Destination Secrets - Prioritize KMS Values**: Imports any secrets present in the Northflank destination prior to syncing, prioritizing values from KMS over Northflank when keys conflict.
                    - **Import Destination Secrets - Prioritize Northflank Values**: Imports any secrets present in the Northflank destination prior to syncing, prioritizing values from Northflank over KMS when keys conflict.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.hanzo.ai/api/v1/secret-syncs/northflank \
