...
- Set up and add envars to [KMS](https://kms.hanzo.ai).
- Install the [KMS CLI](https://kms.hanzo.ai/docs/cli/overview) to your server.

## Setup

<Steps>
    <Step title="Authorize KMS for AB Initio">
        Create a [machine identity](https://kms.hanzo.ai/docs/documentation/platform/identities/machine-identities#machine-identities) in KMS and give it the appropriate read permissions for the desired project and secret paths.
    </Step>
    <Step title="Add KMS CLI to your workflow">
        ...
        hanzo-kms export --projectId="<>" --env="prod" > kms.env
