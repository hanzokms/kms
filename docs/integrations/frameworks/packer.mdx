...
This guide demonstrates how to use the KMS Packer plugin to fetch secret data using a data source. The Packer plugin supports both [KMS Cloud](https://kms.hanzo.ai) and [self-hosted instances of KMS](https://kms.hanzo.ai/docs/self-hosting/overview).
...
packer {
  required_plugins {
    kms = {
      source  = "github.com/ghcr.io/hanzoai/kms"
      version = ">=0.0.1"
    }
  }
}
