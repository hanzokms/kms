...
The Terraform Bridge wraps the [KMS Terraform provider](https://registry.terraform.io/providers/KMS/kms/latest/docs) and exposes its resources (such as `kms_secret`, `kms_project`, and `kms_service_token`) 
