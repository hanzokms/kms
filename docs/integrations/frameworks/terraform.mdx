...
url: "https://registry.terraform.io/providers/KMS/kms/latest/docs"
---
{/* 
...
- KMS (you can use [KMS Cloud](https://kms.hanzo.ai) or a [self-hosted instance of KMS](https://kms.hanzo.ai/docs/self-hosting/overview)) to store your secrets
...
Using a Machine Identity, you can authenticate your Terraform provider using either [OIDC Auth](https://kms.hanzo.ai/docs/documentation/platform/identities/oidc-auth/general) or [Universal Auth](https://kms.hanzo.ai/docs/documentation/platform/identities/universal-auth) methods.

```hcl
provider "kms" {
  host          = "https://kms.hanzo.ai" # Optional for cloud, required for self-hosted
  auth {
...
To eliminate the need for static credentials, you can authenticate your workflow using [OpenID Connect (OIDC)](https://kms.hanzo.ai/docs/documentation/platform/identities/oidc-auth/general) through providers like the [KMS Secrets GitHub Action](https://github.com/KMS/secrets-action).
...
```
For detailed instructions on setting up OIDC authentication with GitHub Actions, refer to our [GitHub Actions OIDC guide](https://kms.hanzo.ai/docs/documentation/platform/identities/oidc-auth/github).
...
- [GitOps Best Practices](https://www.kms.hanzo.ai/blog/gitops-best-practices) */}
