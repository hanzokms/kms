      ...
      <Tab title="PKI">
        <AccordionGroup>
          ...
          <Accordion title="Certificate Sync (Custom SSL)">
            Use the following permissions to grant KMS access to sync certificates to Cloudflare as Custom SSL certificates:
            ...
            **Required Permissions:**
            ...
            These permissions allow KMS to upload, update, and delete custom SSL certificates in your Cloudflare zones.
