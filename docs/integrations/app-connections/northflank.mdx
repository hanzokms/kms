...
description: "Learn how to configure a Northflank Connection for KMS."
---

KMS supports the use of [API Tokens](https://northflank.com/docs/v1/api/use-the-api) to connect with Northflank.

<Tip>
  KMS recommends creating a specific API role for the app connection and only giving access to projects that will use the integration.
</Tip>
...
## Create a Northflank Connection in KMS
...
<Tabs>
  <Tab title="KMS UI">
    <Steps>
      ...
      <Step title="Connection created">
        After submitting the form, your **Northflank Connection** will be successfully created and ready to use with your KMS project.
  ...
  <Tab title="API">
    ...
    ```bash Request
    curl    --request POST \
            --url https://kms.hanzo.ai/api/v1/app-connections/northflank \
