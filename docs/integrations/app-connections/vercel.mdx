        ...
        <Tabs>
            <Tab title="KMS UI">
                ...
                4. Connection Created
                    ...
                    After clicking Create, your **Vercel Connection** is established and ready to use with your KMS project.
            ...
            <Tab title="API">
                ...
                ```bash Request
                curl    --request POST \
                        --url https://kms.hanzo.ai/api/v1/app-connections/vercel \
