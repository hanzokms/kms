...
description: "Learn how to configure an Octopus Deploy Connection for KMS."
---

KMS supports the use of [API Keys](https://octopus.com/docs/octopus-rest-api/how-to-create-an-api-key) to connect with Octopus Deploy.
...
<Tabs>
  ...
  <Tab title="Service Account API Key (Recommended)">
    ...
    <Note>
      KMS recommends using a service account for production integrations as they provide better security and are not tied to individual user accounts.
    </Note>
    <Steps>
...
## Create an Octopus Deploy Connection in KMS
...
<Tabs>
  <Tab title="KMS UI">
    <Steps>
      ...
      <Step title="Connection created">
        After submitting the form, your **Octopus Deploy Connection** will be successfully created and ready to use with your KMS project.
  ...
  <Tab title="API">
    ...
    ```bash Request
    curl    --request POST \
            --url https://kms.hanzo.ai/api/v1/app-connections/octopus-deploy \
