...
description: "Learn how to configure a Chef Connection for KMS."
---
...
KMS supports the use of User Private Key to connect with Chef Server.
...
## Create a Chef Connection in KMS via UI
...
<Tabs>
  <Tab title="KMS UI">
    <Steps>
      ...
      <Step title="Connection created">
        After submitting the form, your **Chef Connection** will be successfully created and ready to use with your KMS project.
  ...
  <Tab title="API">
    ...
    ```bash Request
    curl    --request POST \
            --url https://kms.hanzo.ai/api/v1/app-connections/chef \
