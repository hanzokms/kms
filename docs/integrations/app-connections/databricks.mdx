...
<Accordion title="Configure Permissions for Secret Rotation">
    <Steps>
        <Step title="Add Service Principal to Admin Group">
            ...
            Click **Add** and select the service principal you created for KMS to add it to the admin group.
        ...
        <Step title="Grant Manage Permission to KMS Service Principal">
            In the **User, Group or Service Principal** field, select the service principal you created for KMS. In the **Permission** field, select **Manage** to allow the KMS service principal to manage credentials and secrets for this service principal. Click **Save** to apply the permissions. Repeat these steps for each service principal whose secrets you want to rotate.
