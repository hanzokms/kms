---
title: "SSH"
description: "Learn how to configure an SSH Connection for KMS."
---

KMS supports both SSH key authentication and username-password authentication.
...
<Tabs>
        ...
        <Steps>
           <Step title="Navigate to App Connections">
            ...
            <Step title="Connection Created">
                After clicking Create, your **SSH Connection** is established and ready to use with your KMS project.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
            --url https://kms.hanzo.ai/api/v1/app-connections/ssh \
