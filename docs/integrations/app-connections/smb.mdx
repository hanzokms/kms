---
title: "SMB"
description: "Learn how to configure an SMB Connection for KMS."
---

The SMB Connection allows KMS to connect to Windows servers using the SMB (Server Message Block) protocol for remote management operations such as password rotation.
...
<Tabs>
        ...
        <Steps>
           <Step title="Navigate to App Connections">
            ...
            <Step title="Connection Created">
                After clicking Create, your **SMB Connection** is established and ready to use with your KMS project.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl --request POST \
            --url https://kms.hanzo.ai/api/v1/app-connections/smb \
