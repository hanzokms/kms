...
<Tabs>
  <Tab title="KMS UI">
    <Steps>
      ...
      <Step title="Connection created">
        After submitting the form, your **Railway Connection** will be successfully created and ready to use with your KMS project.
  ...
  <Tab title="API">
    ...
    ```bash Request
    curl    --request POST \
            --url https://kms.hanzo.ai/api/v1/app-connections/railway \
