...
description: "Learn how to configure a DBT Connection for KMS."
---

KMS supports the use of [Personal Access Tokens](https://docs.getdbt.com/docs/dbt-cloud-apis/user-tokens) to connect with DBT.
...
## Create DBT Connection in KMS

<Tabs>
    <Tab title="KMS UI">
        <Steps>
            <Step title="Navigate to App Connections">
                In your KMS dashboard, navigate to the **App Connections** page in the desired project.
            ...
            <Step title="Connection Created">
                After clicking Create, your **DBT Connection** is established and ready to use with your KMS project.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.hanzo.ai/api/v1/app-connections/dbt \
