...
description: "Learn how to configure a MongoDB Connection for KMS."
---

KMS supports the use of Username & Password authentication to connect with MongoDB databases.

## Configure a MongoDB user for KMS

<Steps>
    <Step title="Create a MongoDB user">
        KMS recommends creating a designated user in your MongoDB database for your connection.
    ...
    <Step title="Grant Relevant Permissions">
        ...
        <Tabs>
            <Tab title="Secret Rotation">
                For Secret Rotations, your KMS user will require the ability to create, update, and delete users in the target database:
...
## Create MongoDB Connection in KMS
...
<Tabs>
    <Tab title="KMS UI">
        <Steps>
            ...
            <Step title="Connection Created">
                After clicking Create, your **MongoDB Connection** is established and ready to use with your KMS project.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.hanzo.ai/api/v1/app-connections/mongodb \
