...
description: "Learn how to configure a Redis Connection for KMS."
---

KMS supports the use of Username & Password authentication to connect with Redis databases

## Configure a Redis user for KMS 

<Steps>
    <Step title="Create a Redis user">
        KMS recommends creating a designated user in your Redis database for your connection.
    ...
    <Step title="Grant Relevant Permissions">
        ...
        <Tabs>
            <Tab title="Secret Rotation">
                For Secret Rotations, your KMS user will require the ability to set and delete users:
...
## Create Redis Connection in KMS
...
<Tabs>
    <Tab title="KMS UI">
        <Steps>
            ...
            <Step title="Connection Created">
                After clicking Create, your **Redis Connection** is established and ready to use with your KMS project.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.hanzo.ai/api/v1/app-connections/redis \
