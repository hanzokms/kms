...
description: "Learn how to configure a CircleCI Connection for KMS."
---

KMS supports the use of [API Tokens](https://app.circleci.com/settings/user/tokens) to connect with CircleCI.
<Note>
...
<Steps>
  ...
  <Step title="In the user settings sidebar, select 'Personal API Tokens'">
   ...
   <Step title="Set a name for the token and click 'Add API Token'">
    ...
    You will need this token to configure your KMS connection

    ![Api Keys Page](/images/app-connections/circleci/circleci-create-new-token.png)
  </Step>
</Steps>

## Create a CircleCI Connection in KMS
...
<Tabs>
  <Tab title="KMS UI">
    <Steps>
      ...
      <Step title="Connection created">
        After submitting the form, your **CircleCI Connection** will be successfully created and ready to use with your KMS project.
  ...
  <Tab title="API">
    ...
    ```bash Request
    curl    --request POST \
            --url https://kms.hanzo.ai/api/v1/app-connections/circleci \
