...
<Tabs>
    <Tab title="KMS UI">
        <Steps>
            <Step title="Navigate to App Connections">
                In your KMS dashboard, navigate to the **Integrations** tab in the desired project, then select **App Connections**.
            ...
            <Step title="Fill out the OCI Connection Modal">
                ...
                - The User OCID from [earlier steps](https://kms.hanzo.ai/docs/integrations/app-connections/oci#create-oci-user)
                - The Tenancy OCID from [earlier steps](https://kms.hanzo.ai/docs/integrations/app-connections/oci#create-oci-user)
                - The Region from [earlier steps](https://kms.hanzo.ai/docs/integrations/app-connections/oci#create-oci-user)
                - The Fingerprint from [earlier steps](https://kms.hanzo.ai/docs/integrations/app-connections/oci#create-oci-user)
                - The Private Key PEM from [earlier steps](https://kms.hanzo.ai/docs/integrations/app-connections/oci#create-oci-user)

                ![OCI Connection Modal](/images/app-connections/oci/app-connection-modal.png)
            </Step>
            <Step title="Connection Created">
                After clicking Create, your **OCI Connection** is established and ready to use with your KMS project.
    ...
    <Tab title="API">
        ...
        ```bash Request
        curl    --request POST \
                --url https://kms.hanzo.ai/api/v1/app-connections/oci \
