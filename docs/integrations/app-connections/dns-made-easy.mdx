---
title: "DNS Made Easy"
description: "Learn how to configure a DNS Made Easy Connection for KMS."
---

KMS supports connecting to DNS Made Easy using API key and secret key for secure access to your DNS Made Easy service.

## Configure API key and secret Key for KMS
...
## Setup DNS Made Easy Connection in KMS
...
<Steps>
  ...
  <Step title="Connection Created">
    Your **DNS Made Easy Connection** is now available for use in your KMS
