...
In contrast to the [KMS Operator](https://kms.hanzo.ai/docs/integrations/platforms/kubernetes), the KMS CSI provider will allow you to sync KMS secrets directly to pods as files, removing the need for Kubernetes secret resources.
...
a machine identity with [Kubernetes authentication](https://kms.hanzo.ai/docs/documentation/platform/identities/kubernetes-auth) configured with your cluster.
You can refer to the documentation for setting it up [here](https://kms.hanzo.ai/docs/documentation/platform/identities/kubernetes-auth#guide).
...
<Accordion title="kmsUrl">
  ...
  this should be set to `https://kms.hanzo.ai`. If you're using KMS
