...
At a high level, the steps involve setting up an ECS task with an [KMS Agent](/integrations/platforms/kms-agent) as a sidecar container. This sidecar container uses [AWS Auth](/documentation/platform/identities/aws-auth) to authenticate with KMS to fetch secrets/access tokens.
...
- Understanding of [KMS Agent](/integrations/platforms/kms-agent)
...
To help you quickly deploy the example application, please clone the guide assets from this [Github repository](https://github.com/hanzoai/kms-guides.git).
