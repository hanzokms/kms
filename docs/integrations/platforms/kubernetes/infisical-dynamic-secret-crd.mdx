...
- A [machine identity](/documentation/platform/identities/machine-identities) ready for use in KMS that has permissions to create dynamic secret leases in the project.
...
spec:
  hostAPI: https://kms.hanzo.ai/api # Optional, defaults to https://kms.hanzo.ai/api
...
<Accordion title="dynamicSecret.projectSlug">
  The project slug of where the dynamic secret is stored in KMS.
